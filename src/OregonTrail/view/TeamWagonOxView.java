 ...
 * @author Kim Llanos
 */
public class TeamWagonOxView extends View {
    public TeamWagonOxView() {
        super("To save a report of your Team's Wagon and Oxen, please enter a file path:");
    }
@Override
    public boolean doAction(String[] inputs) {
        ...
        try {
            ...
            teamControl.printTeamWagonOxReport(filePath, team);
